    ...
    <main class="bg">
        <div class="box">
            ...
            <div class="content-box">
                <p>Confirme seu CEP:</p>
                <br>
                <p style="font-size: 0.8rem;"><i class="fa-solid fa-location-dot"></i> CEP</p>
                <form action="<?=PATH?>step-4" method="POST">
                    <div>
                        <input class="cep" name="cep" type="text" autocomplete="off" required>
                    </div>
                    <br>
